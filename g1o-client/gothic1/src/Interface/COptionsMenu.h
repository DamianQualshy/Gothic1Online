...
/*	Menu opcji - menu główne multiplayera dostępne pod klawiszem esc
	Opcje:
	Back to game
	Change apperance //To później, bo przyda się jeszcze jedno menu
	Video options
	Exit game

	Po otwarciu kamera ustawia się w innym miejscu oraz na środku wyświetla się logo Gothic Online pobierane z VDF'a
...
private:
	...
	zCView* goLogo; //instancja logo gothic online wyświetlana z gry
	zCView* background; //Tło
	bool isVisible; //Widoczność menu
