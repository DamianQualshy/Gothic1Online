...
char zCInput::GetLetter(int key)
{
	if(this->KeyPressed(KEY_RMENU) != 0 )
	{
		if( this->KeyPressed(KEY_LSHIFT) == 0 && this->KeyPressed(KEY_RSHIFT) == 0 )
		{
			switch(key)
			{
			case KEY_A: return 'ą'; break;
			case KEY_E: return 'ę'; break;
			case KEY_O: return 'ó'; break;
			case KEY_S: return 'ś'; break;
			case KEY_L: return 'ł'; break;
			case KEY_Z: return 'ż'; break;
			case KEY_X: return 'ź'; break;
			case KEY_C: return 'ć'; break;
			case KEY_N: return 'ń'; break;
