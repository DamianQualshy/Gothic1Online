...
The documentation site uses MkDocs Material. Its function and event reference is generated from `g1odoc` blocks in the C++ sources. Constant pages are generated from the runtime registration table in `g1o-server/Script/SVariable.cpp`.
...
Do not edit files inside the generated `functions`, `events`, or `constants` directories by hand. Edit the corresponding `g1odoc` block or constant registration and regenerate instead. Manual pages under `docs/server-manual` and `docs/client-manual` follow the same concise, behavior-first organization as the GMPC manuals and are preserved by the generator.
